...
result_dir ='./results-in-model/effect-graphs/' + scenario  #compare
...
def train(run, runs):
    ...
    net = MISTAGCN(ACG, ACG, ACG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ADG, ADG, ADG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(AIG, AIG, AIG, K, N, F, Tr, Td, Tw, Tp)

    # net = MISTAGCN(ACG, ACG, ADG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ACG, ACG, AIG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ADG, ADG, ACG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ADG, ADG, AIG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(AIG, AIG, ACG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(AIG, AIG, ADG, K, N, F, Tr, Td, Tw, Tp)

    # net = MISTAGCN(ACG, ADG, AIG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ACG, AIG, ADG, K, N, F, Tr, Td, Tw, Tp)
    # net = MISTAGCN(ADG, AIG, ACG, K, N, F, Tr, Td, Tw, Tp)
