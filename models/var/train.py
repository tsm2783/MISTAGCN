...
from var import VAR
from share import Tp, epochs, threshold, batch_size, devices, runs
...
result_file = 'results/' + scenario + '/VAR-results.xlsx'
...
def train(run, runs):
    ...
    for e in range(epochs):
        ...
        print(
            f'var, run {run+1}/{runs}, train, epoch {e+1}/{epochs}, duration {end-start}s, average train loss {train_loss_mean}')
    ...
    print(f'var, run {run+1}/{runs}, test, duration {end-start}s, average test loss {test_loss_mean}')
